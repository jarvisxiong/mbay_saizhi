...
*  
*/
public class UserMbayTrade implements Serializable {
	 ...
	 * 交易记录
	 */
	private MbayTradeRecord tradeRecord;
	...
	public MbayTradeRecord getTradeRecord() {
		return tradeRecord;
	}

	public void setTradeRecord(MbayTradeRecord tradeRecord) {
