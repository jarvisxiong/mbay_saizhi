...
<link rel="stylesheet" href="${ctx }/traffic_red/mobile/customize/shake/css/shakeUI.css?v=${version}" />
...
<script type="text/javascript" src="${ctx }/traffic_red/mobile/customize/shake/js/acceleration.js?v=${version}"></script>
<script type="text/javascript" src="${ctx }/traffic_red/mobile/customize/shake/js/animation.js?v=${version}"></script>
<script type="text/javascript" src="${ctx }/traffic_red/mobile/customize/shake/js/shakeUI.js?v=${version}"></script>
</head>
...
<section class="shake_bg">
	...
	<p class="mess">摇起来</p>
	<div class="jiggle">
		<p class="shake_img"><img src="${ctx }/traffic_red/mobile/customize/shake/img/shake.png"></p>
	</div>
</section>
...
<div id="shakeTipDiv" style="display: none">
	...
	<p class="access-burse">
		<!--进入MB钱包-->
		<a href="javascript:void(0)" evt-touch="gotoUrl('${walletIndex}')" delegate-id="wallet-index">进入MB钱包</a>
		<!--再摇一次-->
...
<input type="hidden" id="bgImgUrl" value="<fs:fdfs value="${shakeUIImg }" />" /> 
