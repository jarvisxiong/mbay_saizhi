...
//	$(".shake_bottom_bg").addClass('s_b_b');
//	setTimeout('ceshi()',1000);
}

function ceshi(){
	$(".shake_bottom_bg").removeClass('s_b_b');
}
...
function noneheadads() {  
    ...
    var a=document.getElementById("shake_top");
	var b=document.getElementById("shake_bottom");  
    move(a,{"marginTop":-50},function(){
         setTimeout("moveAtoOriginal('shake_top')",300);
    });
	move(b,{"marginTop":50},function(){
		$.messager.closeDialog();
		setTimeout("moveAtoOriginal('shake_bottom')",300);
...
function moveAtoOriginal(id){	
    var picObj=document.getElementById(id); 
	move(picObj,{"marginTop":0},function(){});
}
