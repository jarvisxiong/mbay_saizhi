...
function noneheadads() {  
	...
	move(a,{"marginTop":-100},function(){
	    move(a,{"marginTop":-90},function(){
	         setTimeout("moveAtoOriginal('headads')",400);
	    });
		move(b,{"marginTop":90},function(){
			$.messager.closeDialog();
			setTimeout("moveAtoOriginal('headads2')",400);
