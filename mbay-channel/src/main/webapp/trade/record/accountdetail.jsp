...
<title>收支明细</title>
<link href="${actx}/wro/${version}/account_detail.css"	rel="stylesheet" type="text/css" />
...
<style>
.sub_string{text-overflow: ellipsis;overflow: hidden;white-space: nowrap;margin-bottom:0px;width:192px;}
</style>
</head>
<body>
 <div class='con'>
 <div class='body clearfix'>
        ...
        <!--左边-->  
             ...
             <form id="pagerForm" action="<c:url value="/record/accountdetail.mbay"/>" method="post">      
                <div class='hdlb'>账户收支明细</div>
                <!--身体中部左侧-->
                ...
                <div class='hd_con_r fr'>
	              ...
	              <div class='lb'>
                   <div class='hd'>
                      ...
                      <input type='text' name="number" value="${detail.tradeNumber}" class='bh'/>
	                ...
	                <c:forEach items="${accountdetailitems}" var="detail">
	                    <tr>
	                        <td>${detail.tradeRecord.tradeNumber }<br><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss"  value="${detail.tradeRecord.createTime.toDate() }"/></td>
	                        <td style="width:180px" class="tdn" >
	                        	<div class="sub_string">
									<span title="${detail.tradeRecord.tradeName}">${detail.tradeRecord.tradeName }</span>
								</div>
	                        </td>
	                        
	                        <td>
	                        <c:if test="${detail.paymentType=='INCOME' }">
	                        <fmt:formatNumber
						value="${detail.tradeRecord.amount}" maxFractionDigits="2"
						minFractionDigits="2" />
	                      
	                        </c:if>
	                        </td>
	                        <td> 
	                        <c:if test="${detail.paymentType=='EXPENSE' }">
	                         <fmt:formatNumber
						value="${detail.tradeRecord.amount }" maxFractionDigits="2"
						minFractionDigits="2" />
	                        ...
	                        <td>
	                        <fmt:formatNumber
						value=" ${detail.balance}" maxFractionDigits="2"
						minFractionDigits="2" />
