...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#wechat_add_button").click(function(){
			window.location.href="${ctx}/wechatCampaign/to_campaign_add.mbay";
		});
	});
</script>
</head>
	...
	<div class='con'>
		...
		<div class='body clearfix'>
			<div class='b_con com_width clearfix'>
				...
				<div>
					<form id="pagerForm"
						action="<c:url value="/wechatCampaign/campaign_list.mbay"/>"
						method="post">
						<div class='hdlb'>微信伴侣-活动列表</div>
							...
							<div class='lb'>
								<div class='hd'>
									...
									<img src="<c:url value='/images/workimages/rq.jpg'/>"
										...
										type="submit" style="margin-left: 30px;" class='btn_confirm'
										value='查询' /> <input id="wechat_add_button" type="button"
										style="margin-left: 30px;" class='btn_confirm' value="新增" />
								</div>
							</div>
							<!--表格-->
							<div class='table'>
								<table>
									...
									<c:forEach items="${listevent}" var="event">
										<tr id="strategytr${event.eventnumber}">
											...
											<td><a
												href="<c:url value="/wechatCampaign/campaign_info.mbay?eventnumber=${event.eventnumber}"/>">查看</a>
											</td>
										</tr>
									</c:forEach>
								</table>
