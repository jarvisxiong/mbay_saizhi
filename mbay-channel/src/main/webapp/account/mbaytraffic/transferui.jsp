			...
			<div class='b_con com_width clearfix'>
				...
				<div class='left_con'>
					...
					<div class='dd fr'>
						...
						<form id='mbzz'
							action="<c:url value="/account/mbaytraffic/transfer/dotransfer.mbay"/>"
							method="post">
							<m:token />
                           ...
                           <span class='czll'>换算美贝：</span>
							...
							<div class='yfje'>
								<span class='czll'>账户余额：</span> <span id="amount">								
								<fmt:formatNumber
									value="${mbayTraffic.traffic }" maxFractionDigits="2"
									minFractionDigits="2" />
								</span>
								<span class='je'>MB</span>&nbsp;&nbsp;&nbsp;&nbsp; <a class="czll_a" href="<c:url value="/account/mbaytraffic/transfer/record.mbay"/>">转账记录</a>
							</div>
							<div class='czsl'>
								<span class='czll'><b>*</b>美贝账户：</span> <input
									name="toUserNumber" type="hidden" id="accountvalue" /> <input
									type='text' id="mbayaccount" placeholder='请输入代理账户编号'
									nullmsg="请输入账号" datatype="transfer_account_auth" class='sl_1'
									class='hdmc' /> <a id="usernumber" class="clear-icon" href="javascript:void(0)"></a>
							...
							<div class='czsl'>
								<span class='czll'><b>*</b>转账流量：</span> <input type='text'
									maxlength="11" class='sl_1 onlynum' placeholder='请输入转账数量'
									name="traffic" class='hdmc' datatype="sz"
									errormsg="对不起,您的余额不足！" /> <span class='je'>MB</span> 
									<span class="Validform_checktip" style="margin-left:5px;"></span>
							</div>
							<!-- <div class='czsl'>
							...
							<div style="margin-left: 170px">
								<span class='ssm' id="amounterror">转账说明栏最多可输入100个半角字符。</span>
							</div>
							<div class='an'>
