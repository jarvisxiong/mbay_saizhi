...
<style>
.message-box{display:inline-block; width:600px; text-align:center;font-weight:normal; font-size:18px;color:#fc9720;}
</style>
</head>
<body>
<section id="main-content" class="clearfix">
	<div class="config_lottery">
        ...
        <!-- form开始 -->
        <form id="exchangeItemForm" class="form-horizontal" action="<c:url value="/mall/exchangeItem/addExchangeItem.mbay"/>" enctype="multipart/form-data" method="post">
        <input type="hidden" name="startTime" />
		<input type="hidden" name="endTime" />
		<input type="hidden" name="type" value="${type}" />
		<input type="hidden" name="hide" />
		<input type="hidden" name="extendLimit" />
		<m:token />
        <div class="form-head">
        <h3>展示信息</h3>
    ...
    <dl>
        ...
        <dd>
        	<div class="port_input">
            	<input type="text" autocomplete="off" name="title" datatype="s1-8" errormsg="文字太长，建议8个字符以内"
     ...
     <dl>
        ...
        <dd>
        	<div class="port_input">
            	<input type="text" autocomplete="off" name="description" datatype="s1-16" errormsg="文字太长，建议16个字符以内"
     ...
     <dl>
        ...
        <dd>
        	<div class="port_input">
            	<input type="text" autocomplete="off" name="ruleName" datatype="s1-8" errormsg="文字太长，建议8个字符以内"
            		placeholder="活动规则" maxlength="8"/>
            </div>
            <input style="margin-top:10px;" type="text" autocomplete="off" name="ruleContent" datatype="s1-16" errormsg="文字太长，建议16个字符以内"
     ...
     <dl>
        ...
        <dd>
        	<div class="port_input">
            	<input type="text" autocomplete="off" name="detailName" datatype="s1-8" errormsg="文字太长，建议8个字符以内"
            		placeholder="详细说明" maxlength="8"/>
            </div>
            <input style="margin-top:10px;" type="text" autocomplete="off" name="detailContent" datatype="s1-16" errormsg="文字太长，建议16个字符以内"
            	placeholder="这里加入详细说明" maxlength="16"/>
        </dd>
     </dl>
     <c:if test="${type eq 'COUPON'}">
     <dl style="margin-left: -27px;">
     	<dt>兑换成功文案：</dt>
     	<dd>
     		<div class="port_input">
            	<textarea placeholder='请输入该商品兑换成功后的说明,建议200个字符以内' name="successDescription" class='text-area' 
			 		ignore="ignore" datatype="s1-200" maxlength="200" ></textarea>
            </div>
     	</dd>
     </dl>
	 </c:if>
     ...
     <dt>商品图片：</dt>
                ...
                <div class="upload-content clearfix" id="largeImgTab" style="display:block">
	                ...
	                <div class="Img-box largeImg-group clearfix">
		                ...
		                <div class="img-cotent" id="divOne" style="display:block;">
		                	<div class="img-cont">
		                    	<img id="imageOne" onclick="detailOne.click();" width="148" height="69" src="${actx}/images/mall/default_img_3.jpg" class="largeImg"/>
		                	</div>
                    		...
                    		<span class="colse-img" id="spanOne" onclick="removeImage('detailOne','imageOne','divTwo','spanOne')"><img src="${actx}/images/mall/close.png" /></span>
		                </div>
		                <!-- 详情图2 -->
		                <div class="img-cotent" id="divTwo">
		                	<div class="img-cont">
                    		...
                    		<span class="colse-img" id="spanTwo" onclick="removeImage('detailTwo','imageTwo','divThree','spanTwo')"><img src="${actx}/images/mall/close.png" /></span>
		                </div>
		                <!-- 详情图3 -->
		                <div class="img-cotent" id="divThree">
		                	<div class="img-cont">
                    		...
                    		<span class="colse-img" id="spanThree" onclick="removeImage('detailThree','imageThree','divFour','spanThree')"><img src="${actx}/images/mall/close.png" /></span>
		                </div>
		                <!-- 详情图4 -->
		                <div class="img-cotent" id="divFour">
		                	<div class="img-cont">
                    		...
                    		<span class="colse-img" id="spanFour" onclick="removeImage('detailFour','imageFour','divFive','spanFour')"><img src="${actx}/images/mall/close.png" /></span>
		                </div>
		                <!-- 详情图5 -->
		                <div class="img-cotent" id="divFive">
		                	<div class="img-cont">
                    		...
                    		<span class="colse-img" id="spanFive" onclick="removeImage('detailFive','imageFive','','spanFive')"><img src="${actx}/images/mall/close.png" /></span>
		                </div>               
                    </div>
                </div>
                <!-- 缩略图 -->
                <div class="upload-content" id="smallImgTab" style="display: none;">
                    ...
                    <div class="but-info">
	                    <div class="fl mr20 narrow_img">
	                        <img id="imageThumbnail" width="160" height="100" src="${actx}/images/mall/default_img.jpg" class="smallImg"/>
	                    </div>
                 ...
                 <div class="upload-content" style="display: none;" id="logoTab">
                    ...
                    <div class="but-info">
                    	<div class="fl mr20 narrow_img">
                        	<img id="imageIcon" width="100" height="100" src="${actx}/images/mall/default_img_1.png" />
                        </div>
                        <div class="info fl pt10">
	        ...
	        <dd>
	        	<div class="port_inpit clearfix">
                    <p class="switch-prompt">涉及商品在已添加到图标或Banner图区后，是否需要在首页兑换区隐藏</p>
               		<div class="slider-box off" style="margin: 0;">
						<div class="slider"></div>
						<span class="m">是</span> <span class="w">否</span> 
						<input type="checkbox" name="hide_checkbox" />
					</div>
               </div>
	        </dd>
	    </dl>
        ...
        <div class="lotter_info_content pt20  form-group" style="padding-top:20px;">
	        <dl>
	             ...
	             <dd>
	                 <div class="port_input">
	                     <input type="text" autocomplete="off" name="price" datatype="n1-6" errormsg="最多输入6位数"
	         ...
	         <dl>
	             ...
	             <dd>
	                 <div class="port_input">
	                     <input type="text" min="1" autocomplete="off" name="mbay" datatype="zs1-8" errormsg="最多输入8位数(不包括0)"
	                     	placeholder="兑换该商品所需要的消耗MB">
	                     <span class="unit" style="right: 112px;">M</span>
	                 </div>
	             </dd>
	         </dl>
	         <c:if test="${type eq 'ENTITY'}">
	         <dl>
	         	<dt>剩余库存：</dt>
	         	<dd>
	         		<div class="port_input">
	                     <input type="text" min="1" autocomplete="off" name="remainder" datatype="zs1-8" errormsg="最多输入8位数(不包括0)"
	                     	placeholder="该商品库存数">
             ...
             <dl>
                 ...
                 <dd>
                     <div class="form-combination input-select" style="height:37.6px;width:590px">
                         <div class="port_input">
                             <input class="form-control1" type="text" autocomplete="off" name="userLimit" ignore="ignore" datatype="n1-6" errormsg="最多输入6位数"
                         ...
                         <select class="form-control control1" name="userLimitType" datatype="*" 
                         	...
                         	<option value="PERMANENT" selected="selected">永久</option>
                 ...
                 <dd>
                     <div class="port_inpit clearfix">
                         ...
                         <div class="slider-box off" style="margin: 0;">
							<div class="slider"></div>
							<span class="m">是</span> <span class="w">否</span> 
							<input type="checkbox" name="extendLimit_checkbox" onchange="showOrHide();"/>
						 </div>
                     </div>
                 </dd>
             </dl>
             ...
             <dl class="pb0 object_closest clearfix ml69" style="height: auto; display: table;">
             	...
             	<dd class="object_inside" style="display:none;">
                     <dl class="clearfix w822 b-d-gray">
                     	<dt>每日兑换限制：</dt>
                           ...
                           <div class="inputlist port_input">
                                <input type="text" class="w463" name="dayLimit" ignore="ignore" datatype="n1-6" errormsg="最多输入6位数"
                    ...
                    <dl class="b-t-gray pt20">
                        ...
                        <dd>
                        	<c:if test="${type eq 'COUPON'}">
                        		<input type="button" class="button_sumbit" value="保存并导入劵码" onclick="submit_before()"> 
                        	</c:if>
                        	<c:if test="${type eq 'ENTITY'}">
                        		<input type="button" class="button_sumbit" value="放入仓库" onclick="submit_before()"> 
                        	</c:if>                        
                        </dd>
                    </dl>
             </div>
