 ...
 * 
 */
@Component("LiuMiVNO4Telecom")
public class LiuMiVNO4Telecom implements TrafficRecharge {

	static final Logger LOGGER = LoggerFactory.getLogger(LiuMiVNO4Telecom.class);
	...
	public ChargeResult charge(String mobile,
		...
		TrafficPackage trafficPackage = TrafficPackage
				.getTrafficPacketeCode(OperatorType.TELECOM, traffic);
...
//			statePackagemap.put(OperatorType.MOBILE, mobilePackage);
			 ...
			 */
			Map<Integer, TrafficPackage> telecomPackage = new HashMap<Integer, TrafficPackage>();
			telecomPackage.put(10, "DX10"); telecomPackage.put(30, "DX30"); 
			telecomPackage.put(50, "DX50"); telecomPackage.put(100, "DX100");
			telecomPackage.put(200, "DX200");
			 telecomPackage.put(500, "DX500"); 
			 telecomPackage.put(1024, "DX1024"); 
			 Map<Integer, TrafficPackage> mobilePackage = new HashMap<Integer, TrafficPackage>();
			 		}
	...
	public static void main(String[] args) {
		new LiuMiVNO4Telecom().charge( "13402199832",
