...
public class MBBalanceTest {
	public static void main(String[] args) {
		String url = "http://192.168.21.165:8088/mbay_paymb/trade/v1/balance";
		...
		String[] parameters = { "user_number=D2B620F4", "_input_charset=UTF-8", "mb_ucode=Rmmu4764xXaScscWuQOONQ==" };
		...
		System.out.println(
				"_input_charset=UTF-8&desc=金币兑换&mb_uid=18552015381&orderNumber=201484932749&sign=7b3e6ae9a6255a4c15a36ef2d87951f9&sign_type=MD5&total_fee=2&user_number=D2B620F40a9176a666236f5cf5b5362a852ae63d");
		try {
